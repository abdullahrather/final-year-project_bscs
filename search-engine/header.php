<html>
<head>
	<title>Search Engine with Intelligent Web Spider - [Abdullah Programming]</title>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr class="ewHeaderRow"><!-- *** Note: Only licensed users are allowed to change the logo *** -->
		<td height="50" valign="top"><img src="aspmkrlogo6.png" alt="" border="0"></td>
	</tr>
	<!-- header (end) -->
	<!-- content (begin) -->
	<tr>
...
<!--<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td><span class="phpmaker"><b>Search Engine with Intelligent Web Spider - [Abdullah Programming]</b></span></td></tr>
</table>-->
<?php } ?>
